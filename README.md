This is a sample project that fetches top stories from HN and displays them.

Some Features:
- uses RemoteData package ("krisajenkins/remotedata")
- has a 'Load More' pager
- has an edit title text-box for each story card typing on which will edit that story's title
